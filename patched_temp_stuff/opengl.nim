...
when defined(useGlew):
  ...
  {.pragma: ogl, header: "<OpenGLES/ES2/gl.h>".}
  {.emit: """
#include <OpenGLES/ES2/glext.h>
""".}

elif defined(android):
  {.pragma: ogl, header: "<GLES2/gl2.h>".}
else:
...
wrapErrorChecking:
  ...
  proc glStencilFuncSeparate(face: GLenum, f: GLenum, r: GLint, mask: GLuint) {.importc.}
  ...
  proc glPathStencilFuncNV(f: GLenum, `ref`: GLint, mask: GLuint) {.importc.}
  ...
  proc glAlphaFuncQCOM(f: GLenum, `ref`: GLclampf) {.importc.}
